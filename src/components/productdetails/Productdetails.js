...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-1.jpg.webp')",
                  }} >
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-2.jpg.webp')",
                  }} >
<ul className="product__hover">
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-3.jpg.webp')",
                  }} >
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-4.jpg.webp')",
                  }} >
<ul className="product__hover">
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-5.jpg.webp')",
                  }} >
<ul className="product__hover">
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-6.jpg.webp')",
                  }} >
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-7.jpg.webp')",
                  }} >
<ul className="product__hover">
...
<div className="product__item__pic set-bg" style={{
                    backgroundImage:
                      "url('https://preview.colorlib.com/theme/ashion/img/product/product-8.jpg.webp')",
                  }} >
